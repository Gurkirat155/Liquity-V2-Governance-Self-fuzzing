...
interface IGovernance {
    ...
    /// @return unallocatedOffset Offset associated with unallocated LQTY // VP == 150 vp with the user
    /// @return allocatedLQTY allocated by the user to initatives == 
    /// @return allocatedOffset Offset associated with allocated LQTY // VP == 250 VP initiaitve
