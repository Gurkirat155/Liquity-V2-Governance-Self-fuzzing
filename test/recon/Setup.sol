...
abstract contract Setup is BaseSetup, MockStakingV1Deployer {
    ...
    // @audit is this the same address that is derived in the contract using userProxyAddress function 
    ...
    uint256 internal constant EPOCH_DURATION = 604800;  // 7 days
    uint256 internal constant EPOCH_VOTING_CUTOFF = 518400; // 6 days
